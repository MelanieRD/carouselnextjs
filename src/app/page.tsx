  ...
  const products: Product[] = [
    {
      ...
      images: [
        ...
        "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "https://es.ramtrucks.com/mediaserver/iris?client=FCAUS&market=U&brand=R&vehicle=2025_DT&paint=PCG&fabric=&sa=DT6R98,2TV,22V,APA&pov=fronthero&width=770&height=400&bkgnd=white&resp=jpg&x=&y=&w=&h=&width=500&width=500",
        "https://images.unsplash.com/photo-1580273916550-e323be2ae537?q=80&w=2160&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {products.map((product) => (
            <div
              ...
              onClick={() => product.images.length > 0 && setSelectedProduct(product)}
            >
              <div className="relative aspect-[4/3] overflow-hidden rounded-lg shadow-lg transition-all group-hover:shadow-xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                  ...
                  <p className="text-sm opacity-0 group-hover:opacity-100 transition-opacity">
                    {product.images.length > 0 ? 'Click to view gallery' : 'No images available'}
                  </p>
                </div>
              </div>
            </div>
